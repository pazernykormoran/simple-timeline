  ...
  <div class="container" style="width: 70%; position: absolute; left: 300px; padding-bottom: 50px;">
    ...
    <form action="?task=wydarzenia&action=edytujWydarzeniePerform&idWydarzenia={$idWydarzenia}" method="post" enctype="multipart/form-data">
      <div class="form-group row">
        ...
        <div class="col-4">
          <input class="form-control" name="name" type="text" value="{$wydarzenie->getName()}">
        </div>
      </div>
        ...
        <div class="col-4">
          <div class="form-group">
            ...
            {foreach from=$typy item=typ}
              {if $typ->getId() == $wydarzenie->getType()->getId()}
              <option selected="selected" value= {$typ->getId()}> {$typ->getName()}</option>
              {else}
      ...
      <div class="form-group row">
        ...
        <div class="col-7">
          <textarea class="form-control" name="shortDescription" rows="6" >{$wydarzenie->getShortDescription()}</textarea>
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-7">
          <textarea class="form-control" name="longDescription" rows="6" >{$wydarzenie->getLongDescription()}</textarea>
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-7">
          <input name="startDate" type="date" value="{$wydarzenie->getStartDate()}">
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-7">
          <input name="endDate" type="date" value="{$wydarzenie->getEndDate()}">
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm">
            <input type="submit" class="btn btn-success" value="Edytuj wydarzenie" />
          </div>
          <div class="col-sm">
